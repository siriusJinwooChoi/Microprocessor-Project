...
//static uint32_t ReadAddr = 0x02, PauseReadAddr = 0x00;
...
// For Debugging by HJS
char Char_DataLength[30];
char Char_SpeechStartAdress[30];
...
void WavePlayer_Init(void)
{
  ...
  if(WaveFileStatus == Valid_WAVE_File) /* the .WAV file is valid */
  {
    ...
    //
    //LCD_DisplayChar(Line4, 100, (uint8_t)WAVE_Format.DataSize);
...
void WavePlayer_Init2(void)
{
  ...
  /* Read the Speech wave file status */
  WaveFileStatus = WavePlayer_WaveParsing(SpeechReadAddr2);
...
void WavePlayer_Init3(void)
{
  ...
  /* Read the Speech wave file status */
  WaveFileStatus = WavePlayer_WaveParsing(SpeechReadAddr3);
...
ErrorCode Get_WaveFileStatus2(void)
{
  return (WaveFileStatus);
}

ErrorCode Get_WaveFileStatus3(void)
{
  return (WaveFileStatus);
}
...
void WavePlayer_Start(void)
{
  ...
  sprintf( Char_SpeechStartAdress, "Read Addr : %d", SpeechReadAddr );
  sprintf( Char_SpeechDataOffset, "Data Offset : %d", SpeechDataOffset );
  
  //LCD_DisplayStringLine( Line1, Char_SpeechStartAdress );
  //LCD_DisplayStringLine( Line2, Char_SpeechDataOffset );
  

}

void WavePlayer_Start2(void)
{
  /* Set WaveDataLenght to the Speech wave length */
  WaveDataLength = WAVE_Format.DataSize;
  ...
  ReadAddr = SpeechReadAddr2 + SpeechDataOffset;
...
void WavePlayer_Start3(void)
{
  ...
  ReadAddr = SpeechReadAddr3 + SpeechDataOffset;
...
/* Read the format chunk, must be'fmt ' --------------------------------------*/
  ...
  //////////////////////////////////////////////////////////////////////////////
  // For Debugging by HJS
  sprintf( Char_SampleData, "SamplingRate: %d", WAVE_Format.SampleRate );
  //LCD_DisplayStringLine( Line3, Char_SampleData );
  //////////////////////////////////////////////////////////////////////////////
  ...
  //////////////////////////////////////////////////////////////////////////////  
  // For Debugging by HJS
  sprintf( Char_BitsPerSample, "Bits per Sample: %d", WAVE_Format.BitsPerSample );
  //LCD_DisplayStringLine( Line4, Char_BitsPerSample );
  //////////////////////////////////////////////////////////////////////////////  
