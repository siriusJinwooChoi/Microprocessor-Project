...
int timeC = 0;
char time[30];
extern int c;    //add function
extern int d;    //add function
...
void MySysTickTest()
{
	...
	*(unsigned int *)0xE000E010 &= ~(0x1<<0);
	...
	// SysTick Clock Source ==> external source (HCLK/8) ==> 9 MHz
	*(unsigned int *)0xE000E010 &= ~(1<<2);
	
        
        //*(unsigned int *)0xE000E014 &= ~(0x1<<0);
        //*(unsigned int *)0xE000E014 &= ~(1<<2);
        
        
	// every 0.1 second, SysTick pended
	...
	*(unsigned int *)0xE000E010 |= (1<<0);
        ...
        while(1) { 
          ...
          else if( !(rGPIOE_IDR & (0x01<<1)) ) {
            clock = clock - 900000; 
          }
          *(unsigned int *)0xE000E014 = clock;
        }
...
* Return         : None
*******************************************************************************/
void EXTI0_IRQHandler(void)   //right key!
{
	//
...
//        LCD_DrawArray(minor, c, d, 15, 15);
        ...
        //LCD_DrawArray(minor, c, d, 15, 15);
        //LCD_DrawArray(noblk, c, d+20, 40, 40);
}
...
* Return         : None
*******************************************************************************/
void EXTI1_IRQHandler(void)   //left key!!
{
	//
	//	clear pending bit for each interrupt by writing '1'
	//
...
* Return         : None
*******************************************************************************/
void EXTI9_5_IRQHandler(void)   //up key!!
{
...
* Return         : None
*******************************************************************************/
void EXTI15_10_IRQHandler(void)   //down key!!
{
/*
