...
/* Exported constants ----------------------------------------------------------*/
#define  SpeechReadAddr      0x00000000   /* Speech wave start read address */
#define  SpeechReadAddr2      0x00100000  /* Speech wave start read address */
#define  SpeechReadAddr3      0x00200000  /* Speech wave start read address */
/* Exported macro --------------------------------------------------------------*/
/* Exported functions ----------------------------------------------------------*/
...
void WavePlayer_RecStart2(void);
void WavePlayer_RecStart3(void);
